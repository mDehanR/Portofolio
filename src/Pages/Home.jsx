    ...
    <div className="space-y-2" data-aos="fade-up" data-aos-delay="600">
      <h1 className="text-5xl sm:text-6xl md:text-6xl lg:text-6xl xl:text-7xl font-bold tracking-tight">
        <span className="relative inline-block">
          ...
          <span className="relative bg-gradient-to-r from-white via-blue-100 to-purple-200 bg-clip-text text-transparent">Back-End</span>
        </span>
        <br />
...
const TechStack = memo(function TechStack({ tech }) {
  return <div className="px-4 py-2 hidden sm:block rounded-full bg-white/5 backdrop-blur-sm border border-white/10 text-sm text-gray-300 hover:bg-white/10 transition-colors">{tech}</div>;
});
...
const SocialLink = memo(function SocialLink({ icon: Icon, link, label }) {
  return (
...
const Home = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Portofolio — Back-End Developer</title>
        <meta name="description" content="Portofolio pribadi siswa SMK kelas 10 yang berfokus pada pengembangan Back-End." />
      </Helmet>

      <div className="min-h-screen bg-[#030014] overflow-hidden px-[5%] sm:px-[5%] lg:px-[10%]" id="Home">
        <div className={`relative z-10 transition-all duration-1000 ${isLoaded ? "opacity-100" : "opacity-0"}`}>
          <div className="container mx-auto min-h-screen">
            <div className="flex flex-col items-center justify-center h-screen gap-0 sm:gap-12 lg:gap-20">
              {/* Left Column - Centered */}
              <div className="w-full space-y-6 sm:space-y-8 text-center" data-aos="fade-up" data-aos-delay="200">
                <div className="space-y-4 sm:space-y-6 flex flex-col items-center">
                  ...
                  {/* CTA Buttons */}
                  <div className="flex flex-wrap gap-3 justify-center" data-aos="fade-up" data-aos-delay="1400">
                    <CTAButton href="#About" text="About Me" icon={ExternalLink} />
