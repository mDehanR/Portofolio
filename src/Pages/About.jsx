...
import profileImage from "../assets/pphan.jpg";
    ...
    <div className="relative group" data-aos="fade-up" data-aos-duration="1000">
      ...
      <div className="relative">
        <div className="w-72 h-72 sm:w-80 sm:h-80 rounded-full overflow-hidden shadow-[0_0_40px_rgba(120,119,198,0.3)] transform transition-all duration-700 group-hover:scale-105">
          ...
          <img src={profileImage} alt="Profile" className="w-full h-full object-cover transition-all duration-700 group-hover:scale-110 group-hover:rotate-2" loading="lazy" />
...
const AboutPage = () => {
  ...
  const { totalProjects, totalCertificates, YearExperience } = useMemo(() => {
    ...
    const projectCount = storedProjects.length > 0 ? storedProjects.length : 4;
    const certificateCount = storedCertificates.length > 0 ? Math.max(storedCertificates.length, 1) : 1;
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold" data-aos="fade-right" data-aos-duration="1000">
              ...
              <span className="block mt-2 text-gray-200" data-aos="fade-right" data-aos-duration="1300" itemProp="name">
                Portofolio Owner
              </span>
            </h2>
            ...
            <p className="text-base sm:text-lg lg:text-xl text-gray-400 leading-relaxed text-justify pb-4 sm:pb-0" data-aos="fade-right" data-aos-duration="1500">
              Saya siswa SMK kelas 10 yang sedang belajar pengembangan Back-End. Saya fokus membangun kemampuan dasar pemrograman dan membuat project sederhana secara konsisten.
            </p>
            ...
            >
              ...
              <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">"Leveraging AI as a professional tool, not a replacement."</blockquote>
            </div>

            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href={cvConfig.cvPath} download className="w-full lg:w-auto">
                <button
                  data-aos="fade-up"
